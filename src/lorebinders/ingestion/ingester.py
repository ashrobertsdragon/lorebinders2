...
class EbookIngester:
    """Ingest a book from a source file using ebook2text."""

    def ingest(self, source: Path, output_dir: Path) -> Book:
        ...
        raw_text = self._convert_to_text(source)
    ...
    def _convert_to_text(self, path: Path) -> str:
